...
class Brands extends Model implements Crud
{
    private $id, $en_name, $ar_name, $status, $image, $created_at, $updated_at;
    ...
    {
        $query = "SELECT * FROM brands WHERE status =  " . self::ACTIVE;
